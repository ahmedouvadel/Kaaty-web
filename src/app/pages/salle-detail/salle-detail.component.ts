...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 py-2" *ngIf="salle">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 class="text-xl font-semibold mb-4" i18n="@@salle-info-title">Informations</h3>
                <div class="space-y-3">
                  <div class="flex items-center">
                    ...
                    <span i18n="@@salle-capacite">Capacité: {{salle.capacite}} personnes</span>
                  </div>
                  <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span i18n="@@salle-prix">Prix: {{salle.prix}} €</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 class="text-xl font-semibold mb-4" i18n="@@salle-equipments-title">Équipements</h3>
            ...
            <div class="mb-8">
              <h3 class="text-xl font-semibold mb-4" i18n="@@salle-dates-title">Dates Disponibles</h3>
            ...
            <div class="text-center">
              <button (click)="reserver()"
                      ...
                      class="bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-blue-700 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed" i18n="@@salle-reserve-button">
                Réserver cette salle
              </button>
              <p *ngIf="!selectedDate" class="text-gray-500 mt-2" i18n="@@salle-select-date">
